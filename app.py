...
def load_memes():
    ...
    default_low_risk = [
        ...
        "https://media.giphy.com/media/3o7aCTfyhYawdOX07m/giphy.gif",
    ...
    if st.session_state.input_mode == "Manual Input":
        ...
        with col1:
            ...
            with col_right:
                ...
                BMI = st.number_input("⚖️ BMI", min_value=0.0, max_value=70.0, value=0.0, step=0.1, format="%.1f",
        ...
        with col2:
            st.markdown('<div class="section-header">ℹ️ Quick Info</div>', unsafe_allow_html=True)
            st.markdown("""
            <div class="info-box">
    ...
    # ==================== UPLOAD FILE MODE ====================
        ...
        if uploaded_file is not None:
            ...
            if error:
                ...
                if not has_errors:
                    if warning_fields:
                        st.info(f"ℹ️ Note: {', '.join(warning_fields)} will be imputed with median values.")
                    else:
...
with tab2:
    ...
    with col1:
        ...
        if unit_system == "Metric (kg/cm)":
            weight = st.number_input("⚖️ Weight (kg)", min_value=1.0, max_value=300.0, value=70.0, step=0.5, format="%.1f", key="weight_metric")
            ...
            weight = st.number_input("⚖️ Weight (lbs)", min_value=1.0, max_value=660.0, value=154.0, step=0.5, format="%.1f", key="weight_imperial")
    ...
    with col2:
        ...
        if calculate_bmi and weight > 0 and (height_cm > 0 or height_in > 0):
            ...
            <div class="{color_class}">
                <div class="bmi-category">{icon} {category}</div>
            ...
            bmi_data = {
                ...
                "Status": ["⚠️ Needs Attention", "✅ Healthy", "⚖️ Caution", "⚠️ High Risk"],
            }
